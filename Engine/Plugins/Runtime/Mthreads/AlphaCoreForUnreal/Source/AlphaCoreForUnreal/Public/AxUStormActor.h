...
public:	
	...
	bool LoadSimParmsFromJson();
	void AddDefaultSceneObj();
	void InitTaskJson();
	bool GetRealTaskJson();
	// Called every frame
...
public:	
	...
	// Sim Json
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = StormTask);
	FString SimTaskJson = "";


	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = AxStormMaterial);
	float StepSize = 1.f;
