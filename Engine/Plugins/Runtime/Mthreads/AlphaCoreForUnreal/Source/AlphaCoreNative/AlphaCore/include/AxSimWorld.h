...
public:
	...
	AxSimObject* GetObjectByName(std::string name);
	bool RemoveObjectByName(std::string name);
	bool IsObjectInWorld(std::string name);
...
public:
	...
	void SetRenderImageEmpty();
	void SetDepthImageEmpty();
	void RegistSimObjectRenderImage();
	void RegistSimObjectDepthImage();
