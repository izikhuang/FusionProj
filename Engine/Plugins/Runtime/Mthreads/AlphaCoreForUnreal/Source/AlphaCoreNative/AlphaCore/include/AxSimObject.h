...
public:
	...
	AxUInt32 GetNumRuntimeErrors() { return m_RuntimeErrors.size(); };
	void LogRuntimeErrors();
	void AddRunTimeErrorMessage(std::string message);
	std::string GetRuntimeError(AxUInt32 idx);
protected:
	// Render
