...
protected:
    ...
    void transferNoiseTo2DField(AxCurlNoiseParam noiseParam, AxCurlNoiseParam noiseParam2);
    void transferNoiseTo2DFieldDevice(AxCurlNoiseParam noiseParam, AxCurlNoiseParam noiseParam2);
