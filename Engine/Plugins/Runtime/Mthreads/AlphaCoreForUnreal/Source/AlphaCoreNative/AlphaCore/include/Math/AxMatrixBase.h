...
{
	template<>
	inline AxDataType TypeID<AxMatrix3x3>() { return AxDataType::kFP32; }

	template<>
	inline AxDataType TypeID<AxMatrix3x3D>() { return AxDataType::kFP64; }

	template<>
	inline AxDataType TypeID<AxMatrix4x4>() { return AxDataType::kFP32; }
 
	template<>
	inline AxDataType TypeID<AxMatrix4x4D>() { return AxDataType::kFP64; }

	//------------------------------------------------

	template<>
	inline AxUInt32 TypeVecSize<AxMatrix3x3>() { return 9; }

	template<>
	inline AxUInt32 TypeVecSize<AxMatrix3x3D>() { return 9; }

	template<>
	inline AxUInt32 TypeVecSize<AxMatrix4x4>() { return 16; }

	template<>
	inline AxUInt32 TypeVecSize<AxMatrix4x4D>() { return 16; }
...
ALPHA_SHARE_FUNC AxVector3 operator*(const AxMatrix3x3& mat,const AxVector3& vec)
{
	AxVector3 tmp;;
...
ALPHA_SHARE_FUNC void Transpose(AxMatrix3x3& matx)
{
	AxFp32 tmp;
	tmp = matx.m[1];  matx.m[1] = matx.m[3];  matx.m[3] = tmp;
	tmp = matx.m[2];  matx.m[2] = matx.m[6];  matx.m[6] = tmp;
	tmp = matx.m[5];  matx.m[5] = matx.m[7];  matx.m[7] = tmp;
}

ALPHA_SHARE_FUNC AxMatrix3x3 Transposed(AxMatrix3x3 matx)
{
	AxFp32 tmp;
	tmp = matx.m[1];  matx.m[1] = matx.m[3];  matx.m[3] = tmp;
	tmp = matx.m[2];  matx.m[2] = matx.m[6];  matx.m[6] = tmp;
