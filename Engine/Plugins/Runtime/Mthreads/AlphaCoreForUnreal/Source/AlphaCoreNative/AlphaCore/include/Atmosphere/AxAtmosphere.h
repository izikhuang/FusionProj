...
ALPHA_SPMD_FUNC void CalcAndApplyBuoyancyForce (
...
ALPHA_SPMD_FUNC void MassRatioAndPotentialTemAddSource (
AxScalarFieldF32* massRatioVapor,
AxScalarFieldF32* massRatioCloud,
AxScalarFieldF32* massRatioRain,
AxScalarFieldF32* massRatioVaporSat,
...
AxFp32 condenseCoeff,
AxFp32 accretionCoeff,
AxFp32 autoConversionCoeff,
AxFp32 alphaA,
AxFp32 aT,
AxFp32 alphaK,
AxFp32 latentHeatWater,
...
ALPHA_SPMD_FUNC void ClearFieldByMaskStorm (
AxVecFieldF32* velField,
AxScalarFieldF32* vaporField,
AxScalarFieldF32* cloudField,
AxScalarFieldF32* rainField,
AxScalarFieldF32* thetaField,
AxScalarFieldF32* temperatureField,
AxScalarFieldI8* markField) ;

ALPHA_SPMD_FUNC void CalcGroundTemperature (
AxScalarFieldF32* temGround,
AxFp32 T0,
AxFp32 emitterConst,
AxFp32 temMixScale,
...
ALPHA_SPMD_FUNC void HeightFieldToMarkStorm (
AxScalarFieldI8* markField,
AxScalarFieldF32* heightField,
AxFp32 CloudBasePosOffset,
bool useUEHeight) ;
