...
AxFloatParam NoiseRoughness;
AxIntParam NoiseTurbulence;
AxFloatParam NoiseAttenuation;
...
//AxFloatParam RelHumidityGround;
//AxFloatParam DensityNoiseScale;
AxToggleParam SecondaryShape;
AxVector2FParam Frequency2;
AxFloatParam NoiseAmp2;
AxFloatParam NoiseRoughness2;
AxIntParam NoiseTurbulence2;
AxFloatParam NoiseAttenuation2;
AxFloatParam NoiseSize2;
AxIntParam OffsetSpeed2;
AxVector4FParam Offset2;
