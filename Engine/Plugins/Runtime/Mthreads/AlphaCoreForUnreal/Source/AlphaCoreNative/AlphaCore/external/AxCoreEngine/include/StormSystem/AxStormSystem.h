...
#include "Geometric/AxGeometric.h"
...
public:
    ...
    AxScalarFieldF32* advTempX; // TODO
	AxScalarFieldF32* advTempY; // TODO
	AxScalarFieldF32* advTempZ; // TODO
    AxVecFieldF32* advTempVec;  // TODO
    ...
    virtual void LoadToHost()
    {
        ...
        velXField->LoadToHost();
        velYField->LoadToHost();
        velZField->LoadToHost();
    }
...
public:
    ...
    AxGeometry* GetHeightFieldGeometry() const { return m_HeightFieldGeometry; }
    void SetHeightFieldGeometry(AxGeometry* geo) { m_HeightFieldGeometry = geo; }
    AxStormSysSimParam* GetSimParams() { return &simParam; }
    void SetSimParams(AxStormSysSimParam& params) { simParam = params; }
    void CloudOffsetForRender(); // On Y axis
    //float GetCloudOffset() { return m_CloudOffset; }
    //void SetCloudOffset(float offset) { m_CloudOffset = offset; }
    void SetRenderDensityEmpty() { m_Density = nullptr; } // Is Safe?
...
protected:
    ...
    void ConstructHeightField();
    void ConstructHeightFieldDevice();
...
// SimDatas:
	...
	const AxFp32 latetHeatWater = 2.26f;	// water Latent heat  L = 2.5 * 10^6 J/kg 
