...
namespace AlphaCore
{
	...
	namespace GridDense
	{
		...
		namespace CUDA
		{
			...
			void Divergence(AxVecFieldF32 * srcVecField, AxScalarFieldF32 * dstDivField, AxUInt32 blockSize = 512);

			void Curl(AxVecFieldF32 * srcVecField, AxVecFieldF32 * dstCurlField,AxUInt32 blockSize=512);

			void Length(AxVecFieldF32 * srcVecField, AxScalarFieldF32 * dstLenField, AxUInt32 blockSize = 512);
			...
			void FieldCross(AxVecFieldF32 * a, AxVecFieldF32 * b, AxVecFieldF32 * ret, AxUInt32 blockSize = 512);
			...
			void VorticityConfinement(AxVecFieldF32* velField,
				...
				float dt,AxUInt32 blockSize=512);
			...
			void SimpleGPUStep(AxUInt32 substeps);
