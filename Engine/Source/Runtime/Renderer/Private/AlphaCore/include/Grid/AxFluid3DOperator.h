...
namespace AlphaCore
{
	namespace GridDense
	{
		...
		ALPHA_SHARE_FUNC AxVector3UI IndexToIndex3(AxUInt32 index, AxField3DInfo& info)
		{
			return MakeVector3UI(0);
		}

		ALPHA_SHARE_FUNC AxVector3 Index3ToPos(
		...
		ALPHA_SHARE_FUNC AxVector3 Index3ToPos(AxVector3I id3, AxField3DInfo& info)
		{
			return AlphaCore::GridDense::Index3ToPos(id3.x, id3.y, id3.z, info);
		}

		ALPHA_SHARE_FUNC AxUInt32 Index3ToIndex(int idx, int idy, int idz, AxField3DInfo& info)
		{
			return idz * info.Resolution.x *info.Resolution.y + idy * info.Resolution.x + idx;
		}

		ALPHA_SHARE_FUNC AxUInt32 Index3ToIndex(AxVector3I id3, AxField3DInfo& info)
		{
			return Index3ToIndex(id3.x, id3.y, id3.z, info);
		}

		ALPHA_SHARE_FUNC AxUInt32 PositionToIndex(AxVector3 pos, AxField3DInfo& info)
		{
			return 1;
		}

		ALPHA_SHARE_FUNC AxVector3UI PositionToIndex3(AxVector3 pos, AxField3DInfo& info)
		{
			return  MakeVector3UI(0);
		}

		ALPHA_SHARE_FUNC bool IsInside(int ix, int iy, int iz, const AxField3DInfo& info)
		{
		...
		ALPHA_SHARE_FUNC float GetValue(int idx, 
										 int idy, 
										 int idz, 
										 float* scalarData,
										 AxField3DInfo& info, 
										 float backgroundValue = 0)
		{
			if (!IsInside(idx, idy, idz, info))
				return 0;
			idx = AlphaCore::Math::Clamp(idx, 0, (int)info.Resolution.x - 1);
			idy = AlphaCore::Math::Clamp(idy, 0, (int)info.Resolution.y - 1);
			idz = AlphaCore::Math::Clamp(idz, 0, (int)info.Resolution.z - 1);
			return scalarData[Index3ToIndex(idx, idy, idz, info)];
		}

		ALPHA_SHARE_FUNC float GetValue(AxVector3I id3,
			float* scalarData,
			AxField3DInfo& info,
			float backgroundValue = 0)
		{
		...
		ALPHA_SHARE_FUNC void  SetValue(int idx,
										 int idy,
										 int idz,
										 float value,
										 float* dataRaw,
		...
		ALPHA_SHARE_FUNC AxVector3 GetValueVector(
										 int idx,
										 int idy,
										 int idz,
										 float* dataRawX,
		...
		ALPHA_SHARE_FUNC void SetValueVector(int idx,
										 int idy,
										 int idz,
		...
		ALPHA_SHARE_FUNC AxVector3 GetGradient(
										 int idx,
										 int idy,
										 int idz,
										 float* dataRaw,
		...
		ALPHA_SHARE_FUNC bool IsInside(AxVector3 pos, AxField3DInfo& info)
		{
			AxVector3 size = MakeVector3(
				info.VoxelSize.x * info.Resolution.x,
				info.VoxelSize.y * info.Resolution.y,
		...
		*------------------------------------------------------*/
		...
		ALPHA_SPMD_FUNC AxVector3 SampleValueVector(AxVector3 pos,
							   AxVecFieldF32* vecField,
 							   bool activeBackground = false,
							   float backgroundValue = 0);

		ALPHA_SPMD_FUNC AxVector3 TraceRK3(AxVector3 & pos, AxVecFieldF32* velField, float dt);

  
		ALPHA_SPMD_FUNC void ClampExtrema(AxScalarFieldF32* fieldOld,
									 AxScalarFieldF32* fieldNew,
									 AxVecFieldF32* velField,float dt);

		//seim-lagrangian advect method
		ALPHA_SPMD_FUNC void Advect(AxVecFieldF32* src, 
							   AxVecFieldF32* dst, 
							   AxVecFieldF32* vel,
		...
		ALPHA_SPMD_FUNC void Advect(AxScalarFieldF32* src,
 							   AxVecFieldF32* vel,
							   AxScalarFieldF32* advectTmp,
							   AlphaCore::Flow::AdvectType type,
							   float dt);
		...
		ALPHA_SPMD_FUNC void Advect_MacCormack(AxScalarFieldF32* src,
							   AxScalarFieldF32* dst,
							   AxScalarFieldF32* advectTmp,
							   AxVecFieldF32* velField, 
 							   float dt);
		...
		ALPHA_SPMD_FUNC void Advect_BFECC(AxScalarFieldF32* src,
							   AxScalarFieldF32* dst, 
							   AxScalarFieldF32* advectTmp,
							   AxVecFieldF32* velField, 
 							   float dt);

		ALPHA_SPMD_FUNC void Advect_SemiLagrangian(AxScalarFieldF32* src,
							   AxScalarFieldF32* dst, 
							   AxVecFieldF32* velField, 
 							   float dt);

		ALPHA_SPMD_FUNC void ApplyBuoyancy(AxScalarFieldF32* density,
		...
		ALPHA_SPMD_FUNC void SetBoundaryCondition(AxVecFieldF32* vel,
							   bool openX,bool open_X,
							   bool openY,bool open_Y,
					     	   bool openZ,bool open_Z);


		ALPHA_SPMD_FUNC void FieldMix(AxScalarFieldF32* dst,
		...
		ALPHA_SPMD_FUNC void ProjectNonDivergence(AxVecFieldF32* velField,
		...
		ALPHA_SPMD_FUNC void PressureSolverJacobi(AxScalarFieldF32 * pressureOld, 
							   AxScalarFieldF32 * pressureNew,
							   AxScalarFieldF32 * divField);

		ALPHA_SPMD_FUNC void PressureSolverGaussSeidel(AxScalarFieldF32 * pressureOld,
							   AxScalarFieldF32 * pressureNew,
							   AxScalarFieldF32 * divField);

		ALPHA_SPMD_FUNC void VorticityConfinement(AxVecFieldF32* velField, 
		...
		ALPHA_SPMD_FUNC void AddSourceField_Scalar(
							   AxScalarFieldF32* dstField,
							   AxScalarFieldF32* src,
							   float scale,
							   float dt);

		ALPHA_SPMD_FUNC float CFLCondition(AxVecFieldF32* vecField, float dt);
		///ALPHA_SPMD void VectorFieldMultiplyVector3(AxVecFieldF32* a,AxVecFieldF32* b, AxVector3 vec);

		namespace Internal
		{
			ALPHA_SHARE_FUNC float SampleCubeAndLerp(
			...
			ALPHA_SHARE_FUNC float SampleValue(AxVector3& pos, float* rawData, AxField3DInfo info)
			{
				AxVector3 size = MakeVector3(
					info.VoxelSize.x * info.Resolution.x,
					info.VoxelSize.y * info.Resolution.y,
			...
			ALPHA_SHARE_FUNC float SampleValueOld(
				AxVector3 pos,
				float* scalarData,
				AxField3DInfo& info,
				bool activeBackground = false,
			...
			ALPHA_SHARE_FUNC void Combustion_GridAlign(AxUInt32 x, AxUInt32 y, AxUInt32 z,
				...
				AxField3DInfo& info)
			{
				...
				if (heatVal > 0 && heatVal < 1.0)
					densityVal += (1.0f - heatVal)*dt*heatVal*3.0f;

				SetValue(x, y, z, densityVal, densityRaw, info);
			}

			ALPHA_SHARE_FUNC void SubstractGradient(
				AxUInt32 x, AxUInt32 y, AxUInt32 z,
			...
			ALPHA_SHARE_FUNC AxVector3 Gradient(
				AxUInt32 x, AxUInt32 y, AxUInt32 z,
				float* dataRaw,
				float* dstRawX,
				float* dstRawY,
		...
		ALPHA_SPMD_FUNC void Divergence(AxVecFieldF32 * srcVecField, AxScalarFieldF32 * dstDivField);
		ALPHA_SPMD_FUNC void Curl(AxVecFieldF32 * srcVecField, AxVecFieldF32 * dstCurlField);
		ALPHA_SPMD_FUNC void Length(AxVecFieldF32 * srcVecField, AxScalarFieldF32 * dstLenField);
		ALPHA_SPMD_FUNC void Gradient(AxScalarFieldF32 * srcScalarField, AxVecFieldF32 * dstLenField,bool normalize=false);
		ALPHA_SPMD_FUNC void FieldCross(AxVecFieldF32 * a, AxVecFieldF32 * b,AxVecFieldF32 * ret);
		ALPHA_SPMD_FUNC void SubtractGradient(AxVecFieldF32* velField,AxScalarFieldF32 * pressureField);
		ALPHA_SPMD_FUNC void LinearCombation(
		...
		ALPHA_SPMD_FUNC void Combustion_GridAlign(
		...
		ALPHA_SPMD_FUNC void Combustion_GridSample();

		ALPHA_SPMD_FUNC void Combustion_ParticleSample();
